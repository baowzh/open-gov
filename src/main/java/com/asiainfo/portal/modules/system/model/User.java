package com.asiainfo.portal.modules.system.model;
...
public class User extends UserInfo {
	...
	private String oasystemAcct;
	private String humanresCode;
	private String departName;
	private String updateDepartName;
	...
	public void setSubkindCode(String subkindCode) {
		this.subkindCode = subkindCode;
	}
	public String getOasystemAcct() {
		return oasystemAcct;
	}
	public void setOasystemAcct(String oasystemAcct) {
		this.oasystemAcct = oasystemAcct;
	}
	public String getHumanresCode() {
		return humanresCode;
	}
	public void setHumanresCode(String humanresCode) {
		this.humanresCode = humanresCode;
	}
