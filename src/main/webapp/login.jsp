...
<link href="${ctx }/resources/css/regist/font-awesome.min.css"
	rel="stylesheet">

<link href="${ctx }/resources/js/portal/bootstrap/css/custom.css"
	rel="stylesheet">
	...
	<div class="">
		...
		<div id="wrapper">
			<div id="login" class="animate form">
				<section class="login_content"> <c:choose>
				...
				<form name='f' action="${ctx }/login/login.jhtml" method='POST'
					...
					<div>
						<input type="text" class="form-control" placeholder="用户名"
							required="" name='username' /> <input type="hidden"
							name="userType" value="0" />
					</div>
					<div>
					...
					<div>
						<p class="change_link" style="text-align: left">
							验证码： <img src="${ctx }/login/getvalidcode.jhtml"
								id="randCodeImage" style="width: 70px; height: 30px;"
								onclick="javascript:reloadRandCodeImage();" />
						</p>
					</div>
					<div>
