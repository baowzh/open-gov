...
<div class="headnav">
			...
			<div class="lx-nav">
				<div class="nav1-p t3" style="background-position: 0px 0px;">
					<a href="news/list.jhtml?catId=18&departId=${depart.id}">党务公开</a>
				</div>
			</div>
			<div class="lx-nav">
				<div class="nav1-p t4" style="background-position: 0px 0px;">
					<a href="news/list.jhtml?catId=19&departId=${depart.id}">政务公开</a>
				</div>
			</div>
			<div class="lx-nav">
			...
			<div class="lx-nav">
				<div class="nav1-p t5" style="background-position: 0px 0px;">
					<a href="news/list.jhtml?catId=20&departId=${depart.id}">办事依据</a>
				</div>
			</div>
